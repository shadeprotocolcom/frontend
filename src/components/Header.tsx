    ...
    <header className="border-b border-shade-border">
      <div className="mx-auto flex h-16 max-w-3xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://docs.shade-protocol.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-shade-muted hover:text-white transition-colors text-xs font-medium"
            title="Documentation"
          >
            Docs
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-shade-muted hover:text-white transition-colors"
            title="GitHub"
          >
